...
class SocketIo {
    ...
    public:
        ...
        virtual int get_fd();
        virtual ssize_t read_all(void *buffer, size_t n);
        virtual ssize_t write_all(void *buffer, size_t n);
        virtual ssize_t read_available(void *buffer, size_t n);
        virtual ssize_t write_available(void *buffer, size_t n);
};

}


uerrno - user sace errno
| 3 criticality | 15 project  | 14 modules | 32 error-code |
